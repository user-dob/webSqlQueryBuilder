...
export default class Fixture {
    ...
    create() {
        ...
        co(function *() {
            ...
            yield [...range(1, 100)].map(i => db.sql('INSERT INTO user (name, age) values({name}, {age})', {age: i, name: `name ${i}`}))
        ...
        co(function *() {
            ...
            yield [...range(1, 100)].map(i => db.sql('INSERT INTO post (title, text) values({title}, {text})', {title: `post ${i}`, text: `text ${i} text ${i} text ${i} text ${i} text ${i} text ${i}`}))
        ...
        co(function *() {
            ...
            yield [...range(1, 1000)].map(i => db.sql('INSERT INTO user_post (user_id, post_id) values({user_id}, {post_id})', {user_id: getRandomInt(0, 99), post_id: getRandomInt(1, 100)}))
        ...
        co(function *() {
            ...
            yield [...range(1, 400)].map(i => db.sql('INSERT INTO comment (post_id, text) values({post_id}, {text})', {text: `comment ${i}`, post_id: getRandomInt(1, 100)}))
